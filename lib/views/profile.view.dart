...
class ProfileView extends StatelessWidget {
  ProfileView({super.key, required this.userPosts});
  ...
  Widget userCommenterline (Userposts userPost, Usercomments userComments) => Row(
    crossAxisAlignment: CrossAxisAlignment.start,
    mainAxisAlignment: MainAxisAlignment.start,
    children: [
  ...
  Widget userPostDetails (Usercomments userComments) => Column(
    ...
    children: [
      ...
      userCommenterline(userPosts, userComments),
    ],
  );

  Widget commenter(Userposts userPosts) => Column(
    mainAxisAlignment: MainAxisAlignment.start,
    children: [
      const Divider(color: Colors.grey,),
      Padding(padding:EdgeInsetsGeometry.symmetric(horizontal: 10),
      child: Row(children: [Text(userPosts.numshare, style:boldtxtStyle)],),),
      const SizedBox(height: 15,),
      ...
      Column(
        ...
        children: [
          ...
          Row(
            children: [
              Text('.'),
              const Icon(Icons.group_rounded, size: 15, color: Colors.grey,),
            ],
          ),
        ],
      ),
  ...
  Widget postimage (Userposts userPosts) => Padding(padding: const EdgeInsets.all(10.0),
    child: Column(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Row(
          children: [
            Text(userPosts.postcontent)
          ],
        ),
        const SizedBox(height: 15),
        ClipRRect(
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          buttons(userPosts),
          commenter(userPosts),
          ...userData.commentsList.map((userComment)=> userPostDetails(userComment)),
        ],
      ),
    );
  }
